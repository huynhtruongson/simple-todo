...
func initSeedData(db lib.DB) {
	q := `INSERT INTO users (user_id,fullname,username,email,password) values (1,'fullname seed data','usernameseed','email+seed@gmail.com','seed123123') ON CONFLICT DO NOTHING`
